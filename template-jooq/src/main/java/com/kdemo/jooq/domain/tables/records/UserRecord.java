...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record3<Long, String, String> {
    ...
    private static final long serialVersionUID = -1431374039;
    ...
    /**
     * Setter for <code>jooq.user.gender</code>.
     */
    ...
    /**
     * Getter for <code>jooq.user.gender</code>.
     */
    @Size(max = 1)
     ...
     */
    public UserRecord(Long id, String name, String gender) {
        super(User.USER);
